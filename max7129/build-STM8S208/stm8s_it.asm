...
; genEndFunction
	iret
;	Total TLI_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total AWU_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total CLK_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total EXTI_PORTA_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total EXTI_PORTB_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total EXTI_PORTC_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total EXTI_PORTD_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total EXTI_PORTE_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total CAN_RX_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total CAN_TX_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total SPI_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total TIM1_UPD_OVF_TRG_BRK_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total TIM1_CAP_COM_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total TIM2_UPD_OVF_BRK_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total TIM2_CAP_COM_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total TIM3_UPD_OVF_BRK_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total TIM3_CAP_COM_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total UART1_TX_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total UART1_RX_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total I2C_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total UART3_TX_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total UART3_RX_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total ADC2_IRQHandler function size at codegen: 1 bytes.
...
; genEndFunction
	iret
;	Total TIM4_UPD_OVF_IRQHandler function size at codegen: 24 bytes.
...
; genEndFunction
	iret
;	Total EEPROM_EEC_IRQHandler function size at codegen: 1 bytes.
	.area CODE
	.area CONST
	.area INITIALIZER
	.area CABS (ABS)
