...
; genEndFunction
	ret
;	Total _delay_cycl function size at codegen: 9 bytes.
...
; genEndFunction
	ret
;	Total _delay_us function size at codegen: 54 bytes.
...
; genEndFunction
	addw	sp, #4
	ret
;	Total delay_us function size at codegen: 60 bytes.
...
; genEndFunction
	popw	x
	ret
;	Total delay_ms function size at codegen: 67 bytes.
	.area CODE
	.area CONST
	.area INITIALIZER
	.area CABS (ABS)
